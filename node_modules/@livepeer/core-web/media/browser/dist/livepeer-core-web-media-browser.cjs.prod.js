...
function _arrayWithoutHoles(arr) {
  if (Array.isArray(arr)) return createForOfIteratorHelper._arrayLikeToArray(arr);
}
...
function _toConsumableArray(arr) {
  return _arrayWithoutHoles(arr) || _iterableToArray(arr) || createForOfIteratorHelper._unsupportedIterableToArray(arr) || _nonIterableSpread();
}
...
var getFullscreenMethods = function getFullscreenMethods(element) {
  if (utils.isClient()) {
    var _iterator = createForOfIteratorHelper._createForOfIteratorHelper(methodsList),
      _step;
    try {
          ...
          switch (_context8.prev = _context8.next) {
            ...
            case 11:
              ...
              if (!current.ingestUrl) {
                ...
                if (current.muted !== prev.muted) {
                  if (current.volume === 0) {
                    current._element.volume = media.DEFAULT_VOLUME_LEVEL;
                  }
                }
              } else {
                if (current.muted !== prev.muted) {
                  ...
                  _iterator = createForOfIteratorHelper._createForOfIteratorHelper(audioTracks);
                  try {
                    for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                if (current.video !== prev.video) {
                  ...
                  _iterator2 = createForOfIteratorHelper._createForOfIteratorHelper(videoTracks);
                  try {
            ...
            case 21:
              ...
              if (current._requestedClipLastTime !== prev._requestedClipLastTime && current.clipLength && current.playbackId) {
                ...
                previousPromise = core.createClip({
...
function addMediaMetrics(element, onError, opts) {
  var store = media.createControllerStore({
    ...
    device: getDeviceInfo(core.version.core),
  ...
  var _addMediaMetricsToSto = media.addMediaMetricsToStore(store, onError),
