...
var createNewHls = function createNewHls(source, element, callbacks, config) {
  ...
  var hls = new Hls(_objectSpread2(_objectSpread2({
  ...
  hls.on(Hls.Events.LEVEL_LOADED, /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_e, data) {
      ...
      var _data$details, live, duration, url, _callbacks$onRedirect;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _data$details = data.details, live = _data$details.live, duration = _data$details.totalduration, url = _data$details.url;
              if (!redirected) {
                callbacks === null || callbacks === void 0 ? void 0 : (_callbacks$onRedirect = callbacks.onRedirect) === null || _callbacks$onRedirect === void 0 ? void 0 : _callbacks$onRedirect.call(callbacks, url !== null && url !== void 0 ? url : null);
                redirected = true;
              }
  ...
  hls.on(Hls.Events.MEDIA_ATTACHED, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              _context3.next = _context3.t0 === Hls.ErrorTypes.MEDIA_ERROR ? 10 : _context3.t0 === Hls.ErrorTypes.NETWORK_ERROR ? 12 : 14;
              break;
            case 10:
