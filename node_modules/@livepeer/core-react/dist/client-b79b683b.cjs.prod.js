...
var queryAsyncStoragePersister = require('@tanstack/query-async-storage-persister');
...
function createReactClient({
  ...
  const client$1 = client.createClient(config);
  const persister = config?.storage ? queryAsyncStoragePersister.createAsyncStoragePersister({
    key: 'livepeer.cache',
