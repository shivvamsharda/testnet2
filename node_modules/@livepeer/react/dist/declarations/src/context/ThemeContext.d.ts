...
export declare const ThemeContext: React.Context<Partial<{
    borderStyles: {
    ...
    fontWeights: {
        titleFontWeight?: import("@livepeer/core-web/media").FontWeights | undefined;
        errorTitleFontWeight?: import("@livepeer/core-web/media").FontWeights | undefined;
    };
    sizes: {
